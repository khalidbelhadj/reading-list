    ...
    <ResponsiveDialog open={open} onOpenChange={onOpenChange}>
      <ResponsiveDialogContent showCloseButton={false} className="gap-0 p-4 sm:max-w-sm">
        ...
        <div className="grid grid-cols-[auto_1fr] gap-x-4 gap-y-1.5 text-xs mt-3">
          ...
          <kbd className="font-mono text-muted-foreground">Click</kbd><span>Select item (toggle in bulk mode)</span>
          <kbd className="font-mono text-muted-foreground">Shift+Click</kbd><span>Range select (bulk mode)</span>
