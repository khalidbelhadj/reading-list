...
import { BlockMathNodeView } from "@/components/ui/block-math-node-view";
import { InlineMathNodeView } from "@/components/ui/inline-math-node-view";
...
//      text → math node on load), exactly as components/ui/markdown-card.ts
