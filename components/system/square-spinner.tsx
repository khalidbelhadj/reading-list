...
// waits with their own presence (an agent working, a page assembling) — inline
// button progress stays with Spinner. Keyframes (`spinner-dot-pulse`) live in
// app/globals.css. The order array maps grid positions (TL, TR, BL, BR) to
// delay steps so the pulse travels clockwise.
