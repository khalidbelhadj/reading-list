 ...
 * narration text, and a final `present_results` tool call carrying the summary
...
// Stateless config — one shared instance avoids allocating a transport on
// every render of the hosting component.
