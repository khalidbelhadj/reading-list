...
// `@/db` creates a postgres client at import time. The sync logic under
// test never touches the real client (the DB path is exercised with a fake
// tx below), so stub the module out.
